...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="<%=contextPath%>/personalCenter/mailbox/mailboxManage" class="btn btn-primary btn-block margin-bottom">Back to Inbox</a>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="<%=contextPath%>/personalCenter/mailbox/mailboxManage"><i class="fa fa-inbox"></i> Inbox
