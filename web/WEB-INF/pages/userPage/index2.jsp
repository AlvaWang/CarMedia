                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="<%=contextPath%>resources/dist/img/user1-128x128.jpg" alt="message user image"><!-- /.direct-chat-img -->
                    ...
                    <div class="direct-chat-msg right">
                      ...
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="<%=contextPath%>resources/dist/img/user3-128x128.jpg" alt="message user image"><!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
                  ...
                  <div class="direct-chat-contacts">
                    <ul class="contacts-list">
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<%=contextPath%>resources/dist/img/user1-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<%=contextPath%>resources/dist/img/user7-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<%=contextPath%>resources/dist/img/user3-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<%=contextPath%>resources/dist/img/user5-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<%=contextPath%>resources/dist/img/user6-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<%=contextPath%>resources/dist/img/user8-128x128.jpg" alt="User Image">
              ...
              <ul class="products-list product-list-in-box">
                <li class="item">
                  <div class="product-img">
                    <img src="<%=contextPath%>resources/dist/img/default-50x50.gif" alt="Product Image">
                  </div>
...
<!-- ChartJS 1.0.1 -->
<script src="<%=contextPath%>/resources/plugins/chartjs/Chart.min.js"></script>
